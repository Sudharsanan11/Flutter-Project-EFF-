...
class OutwardCFAItemsNotifier extends StateNotifier<AsyncValue<List<Map<String, String>>>> {
  final ApiService apiService;
  int _limitStart = 0;
  bool _isFetching = false;
  bool _hasAllData = false;

  OutwardCFAItemsNotifier(this.apiService) : super(const AsyncValue.loading()) {
    fetchData();
  }
...
final outwardCFAItemProvider =
    StateNotifierProvider<OutwardCFAItemsNotifier, AsyncValue<List<Map<String, String>>>>(
  (ref) => OutwardCFAItemsNotifier(ApiService()),
);
