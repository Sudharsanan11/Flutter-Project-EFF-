...
class LoadingDetailsNotifier extends StateNotifier<AsyncValue<List<Map<String, String>>>> {
  ...
  LoadingDetailsNotifier(this.apiService) : super(const AsyncValue.loading()){
    fetchData();
  }
...
final loadingDetailsProvider = 
  StateNotifierProvider<LoadingDetailsNotifier, AsyncValue<List<Map<String, String>>>>((ref) => LoadingDetailsNotifier(ApiService()),);